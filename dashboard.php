            ...
            <main class="col-md-9">
                ...
                <div class="container">
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button">Task 1
							<?php
							$t1=$_POST['t1'];
							echo $t1;
							?>
							...
							<button class="sunset-orange-button gradient-button">Task 2
							<?php
							$t2=$_POST['t2'];
							echo $t2;
							?>
							...
							<button class="spring-green-button gradient-button">Task 3
							<?php
							$t3=$_POST['t3'];
							echo $t3;
							?>
							...
							<button class="royal-purple-button gradient-button">Task 4
							<?php
							$t4=$_POST['t4'];
							echo $t4;
							?>
							...
							<button class="ruby-red-button gradient-button">Task 5
							<?php
							$t5=$_POST['t5'];
							echo $t5;
							?>
							...
							<button class="goldenrod-yellow-button gradient-button">Minor Project Module
							<?php
							$mpm=$_POST['mpm'];
							echo $mpm;
							?>
							...
							<button class="spring-green-button gradient-button">Database  Module
							<?php
							$dm=$_POST['dm'];
							echo $dm;
							?>
